...
// const logger = utils.getLogger('eD25519/key.js');
...
module.exports = class ECDSA_KEY  {
  ...
  constructor(key) {
    ...
    if (!key.type || key.asymmetricKeyType !== 'ec') {
  ...
  getSKI() {
    ...
    const pointToOctet = function (key) {
      ...
      // logger.debug('ED25519 curve param X: %s', xBuffer.toString('hex'));
      // logger.debug('ED25519 curve param Y: %s', yBuffer.toString('hex'));
