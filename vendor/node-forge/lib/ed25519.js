 ...
 * TODO YUXZ ADD
 */
ed25519.publicKeyToAsn1 = ed25519.publicKeyToSubjectPublicKeyInfo = function(key) {
	//console.log("key:::::::: ", key);
	//console.log("key:::::::: ", key.toString('hex'));
	//b1 3c e7 b5 3a 97 14 9a 01 62 f9 66 22 d1 3a e3 4f ed 2b 68 48 28 1e 11 e5 1d e0 29 5f 42 e4 42
	//console.log("key:::::::: ",  forge.util.hexToBytes(key.toString('hex')))
	// 30 22 02 20      b1 3c e7 b5 3a 97 14 9a 01 62 f9 66 22 d1 3a e3 4f ed 2b 68 48 28 1e 11 e5 1d e0 29 5f 42 e4 42
  var publicKeyBytes = forge.util.hexToBytes(key.toString('hex'));
  ...
  return asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [
    ...
    asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [
      ...
      asn1.create(asn1.Class.UNIVERSAL, asn1.Type.OID, false,
        asn1.oidToDer(pki.oids.EdDSA25519).getBytes()),
      // parameters (null)
      // asn1.create(asn1.Class.UNIVERSAL, asn1.Type.NULL, false, '')
    ]),
    // subjectPublicKey
    // asn1.create(asn1.Class.UNIVERSAL, asn1.Type.BITSTRING, false, [
    //   ed25519.publicKeyToEd25519PublicKey(key)
    // ])
    asn1.create(asn1.Class.UNIVERSAL, asn1.Type.BITSTRING, false,
			String.fromCharCode(0x00) + publicKeyBytes)
  ]);
};
